...
namespace Wire {
	...
	void EditorLayer::OnUpdate(Timestep ts)
	{
...

		{
			...
			Renderer2D::DrawQuad({ 0.5f, -0.5f }, { 0.5f, 0.75f }, m_SquareColour);
	...
	void EditorLayer::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<WindowResizeEvent>(WR_BIND_EVENT_FN(EditorLayer::PrintSize));

		m_CameraController.OnEvent(e);
	}

	bool EditorLayer::PrintSize(WindowResizeEvent& e)
	{
		WR_INFO("{0}, {1}", e.GetWidth(), e.GetHeight());
